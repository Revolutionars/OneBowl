...
const AnimalsSection = () => {
  ...
  const handleAnimalClick = (animalName: string) => {
    ...
    alert(
      `Great choice! Food options for ${animalName} will be available soon. 🎉`
    );
  };
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Every animal deserves love and care. Choose your furry, feathered,
            or four-legged friend and help us bring them the nourishment they
            need.
          </p>
        </div>
